...
1. **`HANDOFF_2026-09-17.md` — THE entry point** (what runs, what the 09-15/17 sprint established, the open list; operations live in `~/Documents/tinygrad-bench-data/RUNBOOK.md`); then `HANDOFF_2026-09-13.md` (§5d/§5e = the sprint detail; §1 reconnect procedure); then **`HANDOFF_2026-09-12.md`** (the finished card path: every format on NV kernels, the shared JIT arena, the five-file
