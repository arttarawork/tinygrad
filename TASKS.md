...
**Dock + RTX 3090 LIVE 2026-08-24 — TD.1 FIRST LIGHT PASSED** (test_tiny 19 green on
`DEV=NV:NAK`; small-BAR confirmed — see TD.1 status row). **TD.2 truth table is next.**
