...
| 2026-08-19 | T1.8c | agent running | `task/T1.8c-symbolic-attn` | wave 7: kernel-side chunking; the FAST_ATTN measurement is the T4.8 go/no-go |
| 2026-08-19 | T3.6 | agent running | `task/T3.6-signal-bridge` | wave 7: capture-op analysis first, eager prototype second, wire only on measured win |
| 2026-08-19 | T4.11 | agent running | `task/T4.11-gptoss-bytes` | wave 7: tiny-scale repro + size-matched control; per-kernel byte attribution |
