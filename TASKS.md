...
- **T4.98i 🔄 — Q4_1 + IQ4_NL in the NV decode gemv** `[MAC+dock]` deps: T4.98c (agent, 09-11): the last uncovered formats of the two Q4 files (Q4_1 = 0.42 GB of ffn_down in the Q4_0 file; IQ4_NL = 0.26 GB in XL); IQ4_NL shares Q4_0's 18-byte block width, told apart by the 16-float kvalues BUFFER in the dequant graph. On task/T4.98i-nv-quant-q41-iq4nl (6abdd82ca, 24 tests); merge after the real-tensor validation in chain 3.
