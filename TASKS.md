...
**Dock + RTX 3090 LIVE 2026-08-24 — TD.1 ✅ AND TD.2 truth table delivered same night**
(qwen3:8b **31.4 tok/s NAK+BEAM, beats llama.cpp-Metal 27.1**; gpt-oss 26.8 = 1.7x Metal BEAM;
transport exonerated — see TD.2a/TD.2b status rows). Open: T4.14 compile-server fix (in
flight) → rerun skipped `DEV=NV` cells (tensor-core lane, likely fastest); then TD.3.
