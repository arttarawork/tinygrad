...
`80bf60d78`, 2026-08-21 — on `sync/upstream-2026-08-21`, awaiting Artur's push to master);
watch upstream #17446 (competing gpt-oss arch — merge would conflict with our T1.3 in
`llm/model.py`).
