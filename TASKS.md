...
compile-server bug found+fixed en route (prime PR candidate). Next: TD.3 (pooling flagship,
in progress), T4.15/T4.16 filler, PR-train route decision (now incl. T4.14).
