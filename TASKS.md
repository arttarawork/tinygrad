...
| 2026-08-19 | bench window 2 | agent running | `task/bench-window-2` | 00:0x: llama-server STOPPED (restore: `launchctl bootstrap gui/501 ~/Library/LaunchAgents/com.artur.llama-server.plist`). Sequential batch: A) integrated re-bench qwen3:8b (vs 08-18: 7.28/14.44; Q4_K 2x should show), B) T1.1b fp16-KV delta incl. long-context, C) T4.4 beam-prefill anomaly repeats+bisect, D) T4.3 gpt-oss-20b parity vs llama-cli. Wave 6 (T4.7/T4.8/T4.9) fires AFTER window closes. |
